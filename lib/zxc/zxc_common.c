...
/* The kernel build maps ZXC_ALIGNED_MALLOC / ZXC_ALIGNED_FREE directly onto the
 * slab-backed aligned helpers in zxc_deps.h, so these libc-based defaults (which
 * would reference posix_memalign/free) are compiled out. */
