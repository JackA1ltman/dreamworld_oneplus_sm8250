...
/* Calculate the page index where the MFT record resides. */
...
/* Calculate the byte offset within a page for an MFT record. */
...
/* Convert page index to cluster number. */
...
/* Convert cluster number to page index. */
...
/* Get the byte offset within a page from a cluster number */
